...
class ObjectTracker:
    def __init__(self, abandoned_threshold_frame):
        ...
        # Define how long the system decide if the object abandoned or not
        self.abandoned_threshold_frame = abandoned_threshold_frame
