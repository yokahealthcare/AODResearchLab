...
class AodDetectorMog:
    def __init__(self):
        self.mog = cv2.createBackgroundSubtractorMOG2(history=7000, detectShadows=False)
        self.mog.setVarThreshold(75)
    ...
    def detect(self, frame, lr=-1):
        ...
        self.mask = self.mog.apply(frame, learningRate=lr)
    ...
    def get_variables(self):
        return self.mask, self.mog.getBackgroundImage()
